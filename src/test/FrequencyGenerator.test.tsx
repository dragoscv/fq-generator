...
describe('FrequencyGenerator - Emergency Audio Fix', () => {
  ...
  describe('Audio Initialization', () => {
    it('should initialize audio context on user interaction', async () => {
      ...
      // Act
      const initButton = screen.getByRole('button', { name: /initialize audio/i })
    ...
    it('should handle initialization errors gracefully', async () => {
      // Arrange
      const initError = new Error('InvalidAccessError: Audio context initialization failed')
      ...
      expect(screen.getByRole('button', { name: /initialize audio/i })).toBeInTheDocument()
    })
  })
  ...
  describe('Frequency Control', () => {
    ...
    it('should update frequency via input field', async () => {
      ...
      // Act
      const frequencyInput = screen.getByRole('spinbutton', { name: /frequency/i })
  ...
  describe('Component Rendering', () => {
    it('should render all essential controls', () => {
      ...
      expect(screen.getByRole('button', { name: /initialize audio/i })).toBeInTheDocument()
      expect(screen.getByRole('spinbutton', { name: /frequency/i })).toBeInTheDocument()
